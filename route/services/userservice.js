 ...
 //var id=1;
  ...
  module.exports.uploaddata=((req,res)=>{
    ...
    var mon = today.getMonth() + 1;
      ...
      userRepo.upload({firstname:firstname},{lastname:lastname},{email:email},{password:password},{file:file},{DOJ:DOJ},{phonenumber:phonenumber},{gender:gender},{DOB:DOB},{resgination:resgination},{reportmanager:reportmanager},{nextimmediatemanager:nextimmediatemanager},{hrmanager:hrmanager},(err,data)=>{
        if(data){
        res.json({
          ...
          var mailOptions = {
            ...
            text: 'Dear  '+firstname+','+('\n\n')+ 'Your succesfully register in HRMS portal, Kindly update your education and personal details in the portal.'+('\n\n')+'Please find username,password mentioned below. '+('\n\n')+'UserName:'+email+('\n')+'Password:'+password+('\n')+ 'Thanks and regards.'+('\n\n')+' HR Operations.'+('\n\n')+'Link:https://umeshrapolu29.github.io/hrms-employee/hrms-employee#/signin'
...
module.exports.addiprocurement=(req,res)=>{
 ...
 const resume = req.file.originalname;
  ...
  userRepo.addiprocuremnt({item:item},{description:description},{amount:amount},{file:file},{status:status},{astatus:astatus},{email:email},{employeename:employeename},{empname:empname},{resume:resume},(err,data)=>{
    if(data){
      res.json({
  ...
  module.exports.resetpassword=((req,res)=>{
    ...
    module.exports.adminresetpassword=((req,res)=>{
      ...
      module.exports.profiledetails=((req,res)=>{
        ...
        console.log(fullid+"fullid at service");
        console.log(id,reportingmanager,fullid+"at service");
        
        // console.log(empname,primaryemailid,secondaryemailid,primaryphone,secondaryphone,gaurdain,gaurdainnumber+"at service")
       console.log(fullname,DOB,DOJ,gender,email,phone,reportingmanager,nextreportingmanager,hrmanager+"at service")
         userRepo.profiledetails({empname:empname},{fullname:fullname},{DOB:DOB},{DOJ:DOJ},{gender:gender},{email:email},{phone:phone},{reportingmanager:reportingmanager},{nextreportingmanager:nextreportingmanager},{hrmanager:hrmanager},{id:id},{fullid:fullid},(err,data)=>{
          if(data){
            res.json({
              "msg":"data inserted111",
              "data":data
            })
